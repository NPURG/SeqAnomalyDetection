...
lm_d = {
		...
		'addr1394': [(0.993, 1), (0.981, 1.04)], #[(0.97, 1.02), (0.95, 1.04)]#[(0.98, 1), (0.99, 1.04)]#[(0.92, 1.04), (0.95, 1.04)],#[(0.97, 1.02), (0.99, 1.04)] [(0.88, 1), (0.99, 1.04)],#[(0.99, 1), (0.9, 1)], ## TODO
		'addr1394-single': [(0.998, 1), (0.981, 1.04)] #[(0.993, 1), (0.981, 1.04)], ## [(0.993, 1), (0.981, 1.04)] TODO
	}
